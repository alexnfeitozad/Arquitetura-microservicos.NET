...
function lessonContent(chapter, lesson, index) {
  ...
  return { ...concepts, lesson, chapter, index, diagram: ['Contexto', 'Decisão', 'Código', 'Verificação'] };
}
